...
from utils.common import apply_custom_style, add_sidebar_header

# 直接使用Streamlit的set_page_config，而不是导入自定义函数
st.set_page_config(page_title="智能视频分析系统 - 效果对比", layout="wide")
apply_custom_style()
